...
#include <xrpld/app/misc/detail/NetworkStateImpl.h>
 ...
 */
class NetworkStateImpl::StateAccounting
{
    struct Counters
    {
...
std::array<Json::StaticString const, 5> const
    NetworkStateImpl::StateAccounting::states_ = {
...
NetworkStateImpl::~NetworkStateImpl() = default;

OperatingMode
NetworkStateImpl::getOperatingMode() const
{
    return mode_;
}

std::string
NetworkStateImpl::strOperatingMode(OperatingMode mode, bool admin) const
{
...
std::string
NetworkStateImpl::strOperatingMode(bool admin) const
{
    return strOperatingMode(mode_, admin);
}

bool
NetworkStateImpl::isFull()
{
    return !isNeedNetworkLedger() && (mode_ == OperatingMode::FULL);
}

void
NetworkStateImpl::setMode(OperatingMode om)
{
...
bool
NetworkStateImpl::isBlocked()
{
    return amendmentBlocked_ || unlBlocked_;
}

bool
NetworkStateImpl::isAmendmentBlocked()
{
    return amendmentBlocked_;
}

void
NetworkStateImpl::setAmendmentBlocked()
{
...
bool
NetworkStateImpl::isAmendmentWarned()
{
    return !amendmentBlocked_ && amendmentWarned_;
}

void
NetworkStateImpl::setAmendmentWarned()
{
    amendmentWarned_ = true;
}

void
NetworkStateImpl::clearAmendmentWarned()
{
    amendmentWarned_ = false;
}

bool
NetworkStateImpl::isUNLBlocked()
{
    return unlBlocked_;
}

void
NetworkStateImpl::setUNLBlocked()
{
    unlBlocked_ = true;
    setMode(OperatingMode::CONNECTED);
}
...
void
NetworkStateImpl::clearUNLBlocked()
{
    unlBlocked_ = false;
}

bool
NetworkStateImpl::isNeedNetworkLedger()
{
    return needNetworkLedger_;
}

void
NetworkStateImpl::setNeedNetworkLedger()
{
    needNetworkLedger_ = true;
}

void
NetworkStateImpl::clearNeedNetworkLedger()
{
    needNetworkLedger_ = false;
}

void
NetworkStateImpl::setStandAlone()
{
    setMode(OperatingMode::FULL);
}

void
NetworkStateImpl::stateAccounting(Json::Value& obj) const
{
